...
import 'package:phone/presentation/pages/screen_dialpad/widget/dialer_dtmf.dart';
import 'package:phone/presentation/pages/screen_dialpad/widget/masked_text_controller.dart';
...
class _DialPadState extends State<DialPad> {
  ...
  void initState() {
    textEditingController = MaskedTextController(
      mask: '************', // Allow up to 12 characters
      translator: {
        '*': RegExp(r'[0-9*#]'), // Allow 0-9, *, and #
      },
    );
    super.initState();
  }
  ...
  _setText(String? value) async {
    ...
    if ((widget.enableDtmf ?? false)) {
      await Dtmf.playTone(digits: value.trim(), samplingRate: 8000, durationMs: 160);
    }
